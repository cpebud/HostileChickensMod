                ...
                if (worldIn.isAirBlock(blockpos))
                {
                    if (worldIn.isRemote)
                    {
                        for (int j = 0; j < 128; ++j)
                        {
                            ...
                            worldIn.spawnParticle(EnumParticleTypes.BLOCK_CRACK, d1, d2, d3, (double)f, (double)f1, (double)f2, Block.getIdFromBlock(worldIn.getBlockState(pos.down()).getBlock()));
                        }
                    }
                    else
                    {
